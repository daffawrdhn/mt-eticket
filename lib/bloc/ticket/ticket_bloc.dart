...
class TicketBloc extends Object {
  ...
  Future<TicketsResponse> getTodoHistory() async {
    appData.setErrMsg("");
    TicketsResponse response = await _ticket.todohistory();
    if (response.results.success == true) {
      _subject.sink.add(response);
      return response;
    } else {
  ...
  Future<TicketsResponse> getTodo() async {
    appData.setErrMsg("");
    TicketsResponse response = await _ticket.todo();
    if (response.results.success == true) {
      _subject.sink.add(response);
      return response;
    } else {
